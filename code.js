...
var NodeNames;
(function (NodeNames) {
    NodeNames["Dropdown"] = "Dropdown";
    NodeNames["Lozenge"] = "Lozenge";
    NodeNames["Button"] = "Button";
    NodeNames["Input"] = "Text input";
    NodeNames["Tab"] = "Tab";
    NodeNames["Link"] = "Link";
    NodeNames["RadioButton"] = "Radio button";
})(NodeNames || (NodeNames = {}));
...
const traverseNodeAndGetCharacter = (node) => {
    if (node.type === "TEXT") {
